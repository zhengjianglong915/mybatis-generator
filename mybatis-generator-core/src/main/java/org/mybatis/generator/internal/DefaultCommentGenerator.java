...
public class DefaultCommentGenerator implements CommentGenerator {
    ...
    public void addComment(XmlElement xmlElement) {
        ...
        // 注解只是用来标注是自动化生成的，方便xml 代码合并
        sb.append("<!-- " + MergeConstants.NEW_ELEMENT_TAG + " " + s + " -->");
    ...
    public void addGeneralMethodComment(Method method, IntrospectedTable introspectedTable) {
        ...
        sb.append(" * This method is to " + method.getName()); //$NON-NLS-1$
        ...
        if (returnTypeOptional.isPresent()) {
            FullyQualifiedJavaType returnType = returnTypeOptional.get();
            sb.setLength(0);
    ...
    public void addGetterComment(Method method, IntrospectedTable introspectedTable,
        ...
        method.addJavaDocLine("/**"); //$NON-NLS-1$
        sb.append(" * This method returns the value of "); //$NON-NLS-1$
    ...
    public void addSetterComment(Method method, IntrospectedTable introspectedTable,
        ...
        method.addJavaDocLine("/**"); //$NON-NLS-1$
        sb.append(" * This method sets the value of "); //$NON-NLS-1$
        sb.append(introspectedColumn.getActualColumnName());
        method.addJavaDocLine(sb.toString());
